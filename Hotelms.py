class hotelfarecal:
    def __init__(self,rent='',s=0,p=0,r=0,t=0,a=1800,name='',address='',cindate='',coutdate='',rno=101):
        print ("\n\n*****WELCOME TO HEWING HOTEL*****\n")
        self.rt=rent # declare the rent amount
        self.r=r     # declare the restaurant bill
        self.t=t     # checking launtry bill amount
        self.p=p     # declare game bill us p
        self.s=s     # type of room staying
        self.a=a     # additional service charge 
        self.name=name
